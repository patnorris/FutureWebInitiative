...
//import { html2canvas } from './html2canvas/core';
//var html2canvas = require('./html2canvas/core');
...
AFRAME.registerShader('html', {
  ...
  __draw (canvas) {
    log('__draw')
    console.log('__draw canvas', canvas)
    if (!this.__ctx || !this.__texture) { return }
  ...
  __render () {
    ...
    console.log('__render this.__targetEl', this.__targetEl)
